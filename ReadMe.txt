========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : wgetUI
========================================================================


Diese wgetUI-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
res\wgetUI.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei wgetUI.rc eingebunden.
...
wgetUIDlg.h, wgetUIDlg.cpp - das Dialogfeld
    	Diese Dateien enthalten die Klasse CWgetUIDlg. Diese Klasse legt das
    	Verhalten des Haupt-Dialogfelds der Anwendung fest. Die Vorlage des Dialog-
	felds befindet sich in wgetUI.rc, die mit Microsoft Visual C++
...
StdAfx.h, StdAfx.cpp
	...
	wgetUI.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
